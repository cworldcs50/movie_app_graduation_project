...
class GetPopularMoviesCardsUsecase
    extends BaseUsecase<List<Movies>, NoParameters> {
  final MoviesBaseRepository moviesBaseRepository;

  GetPopularMoviesCardsUsecase({required this.moviesBaseRepository});

  @override
  Future<Either<Failure, List<Movies>>> call(
    NoParameters parameters,
  ) async => await moviesBaseRepository.getPopularMoviesCards();
}
